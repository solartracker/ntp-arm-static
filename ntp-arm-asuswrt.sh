...
if [ ! -f "${PKG_BUILD_SUBDIR}/__package_installed" ]; then
    ...
    STRIP=strip
    READELF=readelf
    CFLAGS_COMMON="-O2 -g -Wno-switch -Wno-array-bounds -Wno-implicit-fallthrough -Wno-unused-value -Wno-switch-bool -Wno-expansion-to-defined -Wno-format-security -Wno-unused-result -Wno-strict-aliasing -Wno-format-diag -Wno-stringop-overflow -Wno-format-overflow -Wno-stringop-truncation -Wno-cast-function-type -Wno-ignored-qualifiers"
